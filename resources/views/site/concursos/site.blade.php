...
@php
  // Valores padrão, caso o controller não injete $site
  $site = $site ?? [
    'brand'        => 'GestaoConcursos',
    'primary'      => '#0f172a',  // topo
    'accent'       => '#111827',  // botões
    'banner_url'   => null,
  ...
  <style>
    ...
    *{ box-sizing:border-box; }
    ...
    .site-header{
      ...
      background:var(--site-primary); color:#fff; border-bottom:1px solid rgba(255,255,255,.08);
    }
    .nav{ display:flex; align-items:center; justify-content:space-between; height:64px; }
    .brand{ display:flex; align-items:center; gap:10px; font-weight:800; letter-spacing:-.02em; }
    .brand .logo{
      width:28px; height:28px; border-radius:6px; background:#1d4ed8; display:inline-block;
    ...
    .cta{
      ...
      background:#fff; color:var(--site-primary); font-weight:600;
      border:1px solid rgba(255,255,255,.0);
    }
    .cta:hover{ filter:brightness(0.98); }

    main{ flex:1 1 auto; background:#fff; }

    /* FOOTER */
    .site-footer{ background:var(--site-primary); color:#fff; margin-top:32px; }
    .site-footer .grid{
      display:grid; grid-template-columns:1.2fr 1fr 1fr; gap:18px; padding:28px 0;
    }
    .site-footer .muted{ opacity:.8; font-size:14px; }
    .site-footer hr{ border:0; height:1px; background:rgba(255,255,255,.15); margin:6px 0 14px; }
  ...
  <header class="site-header">
    <div class="container nav">
      ...
      <nav class="menu" aria-label="Menu do site">
        ...
        <a href="{{ route('site.concursos.index') }}">Concursos / Processos</a>
