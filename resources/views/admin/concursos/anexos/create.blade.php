{{-- resources/views/admin/concursos/anexos/create.blade.php --}}
@extends('layouts.sigecon')
@section('title', 'Novo Anexo - SIGECON')
...
<div class="gc-page">
  ...
  <div class="gc-row-2">
    <div class="gc-card">
      <div class="gc-body">
        <div class="mb-2" style="font-weight:600">Publicar anexo</div>
