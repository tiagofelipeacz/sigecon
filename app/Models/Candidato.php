...
class Candidato extends Authenticatable implements MustVerifyEmailContract
{
    ...
    protected $fillable = [
        ...
        // Documentos (presentes no formulário)
        'doc_tipo','doc_numero','doc_orgao','doc_uf','doc_complemento',

        // Credenciais/controle
    ...
    /**
     * Normaliza CPF para somente dígitos ao setar.
     */
    ...
    /**
     * Helper para exibir CPF com máscara nas views.
     * Ex.: {{ $candidato->cpf_masked }}
     */
