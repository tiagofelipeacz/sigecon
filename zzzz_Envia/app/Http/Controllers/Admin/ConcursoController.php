...
class ConcursoController extends Controller
{
    ...
    public function updateConfig(Request $request, Concurso $concurso)
    {
        ...
        // Se a sua tabela tiver colunas físicas, também preenche
        if (in_array('data_isencao_inicio', $concursosCols, true)) {
            $base['data_isencao_inicio'] = $isoIni; // grava ISO ou null
        }
        ...
        // Se pedidos de isenção estiverem desativados, limpamos a pivot
        ...
        // respeita o flag do form (MESMO NOME que você usa no Blade)
